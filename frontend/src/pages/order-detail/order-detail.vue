      ...
      <view class="user-info">
        ...
        <view class="info-item" v-if="order.lender">
          ...
          <view class="user-info-row">
            <image class="user-avatar" :src="order.lender.avatar || '/static/logo.png'" mode="aspectFill"/>
        ...
        <view class="info-item" v-if="order.borrower">
          ...
          <view class="user-info-row">
            <image class="user-avatar" :src="order.borrower.avatar || '/static/logo.png'" mode="aspectFill"/>
